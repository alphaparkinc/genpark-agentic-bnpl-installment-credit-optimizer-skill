# genpark-agentic-bnpl-installment-credit-optimizer-skill
...
**genpark-agentic-bnpl-installment-credit-optimizer-skill** is a deterministic, zero-dependency Python skill engineered for autonomous consumer shopping agents, checkout tokenization, and e-commerce decision intelligence.

> **Executive Capability**: Autonomous BNPL installment schedule & credit term optimizer (Klarna / Affirm)
...
result = client.optimize_installment_plan()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-agentic-bnpl-installment-credit-optimizer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-agentic-bnpl-installment-credit-optimizer-skill/mcp_server.py"]
    }
  }
}
```
